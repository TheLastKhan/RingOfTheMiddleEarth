...
README haricindeki dokumanlar `docs/` klasoru altinda tutulur.
`docs/TermProject_RingOfTheMiddleEarth.md` resmi odev metnidir ve bu guncellemede
...
| Dosya | Rol |
| --- | --- |
| `docs/TermProject_RingOfTheMiddleEarth.md` | Resmi proje gereksinimleri. Kaynak dokuman. |
| `README.md` | Hizli baslangic, servisler, endpointler ve son test durumu. |
| `docs/CALISTIRMA_REHBERI.md` | Projeyi bastan sona ayaga kaldirma ve test etme runbook'u. |
| `docs/SUNUM_REHBERI.md` | Demo akisi, Q&A cevaplari ve sunum komutlari. |
| `docs/TEKNOLOJI_EGITIM.md` | Kafka, Go, SSE, Docker ve mimari kavramlarinin sade anlatimi. |
| `docs/architecture-document.md` | Mimari kararlar, sinirlar, rubric evidence ve LLM usage log. |
| `docs/sonnet.md` | Eski uzun AI notlarinin arsiv ozeti; source of truth degildir. |
...
1. `docs/TermProject_RingOfTheMiddleEarth.md`
2. Calisan kod ve testler
3. `docs/architecture-document.md`
4. `README.md` ve `docs/CALISTIRMA_REHBERI.md`
5. Sunum/egitim notlari
6. `docs/sonnet.md` arsiv ozeti
...
Bu sinirlar gizlenmemis, `README.md` ve `docs/architecture-document.md` icinde acikca
belirtilmistir.
